...

  {
    ...
    steps: [
      ...
      },
      {
        from: '先輩',
        message:
          'ここからが本題ね。いま消えたのは最新のコミットからだけ。git diff HEAD~1 HEAD を打ってみて ― .env が「消えた側」に出るでしょ。つまり 1 つ前にはまだ入ってる。しかも push しちゃってるから本店にも残ってるし、本店から取っていった人の手元にも残ってる。履歴から本当に消す手はあるけど、それは全員が手元を作り直す話で、その段取りをしてるあいだも合鍵は有効なまま。だから 1 番目にやるのは合鍵の作り直しだよ。それが済めば、履歴に残ってるのはただの古い文字列。作り直しは僕がやっとくから、いまの状態を本店に送っといて。',
